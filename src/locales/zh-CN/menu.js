export default {
  ...
  'menu.relevancy': '相关度分析',
  'menu.relevancy.newsRelevancy': '新闻主题相关度',
  'menu.relevancy.newsRelevancy.articles': '新闻列表',
  'menu.list': '新闻相关度分析',
  'menu.list.searchtable': '查询表格',
  'menu.list.basiclist': '标准列表',
  'menu.list.cardlist': '卡片列表',
  'menu.list.searchlist': '新闻列表',
  ...
  'menu.share': '股票市场',
  'menu.share.analysis': '大盘预测',
  'menu.share.monitor': '情感度分析',
};
